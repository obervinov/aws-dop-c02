...
```
sam deploy --template-file /Users/obervinov/Desktop/aws-dop-c02/aws-sam/aws_sam_ocr/packaged.yaml --stack-name aws-sam-ocr --capabilities CAPABILITY_IAM --region us-east-1
```